...
export type Env = {
  ...
  ME_MMM_POOLS_PATH?: string;
  ME_MMM_FULFILL_SELL_PATH?: string;
  ME_FLOOR_PRICE_UNIT?: string;
  TENSOR_API_KEY?: string;
  TENSOR_API_BASE_URL?: string;
  TENSOR_COLLECTION_SLUG?: string;
  FROGX_ACCOUNT_MODE_ENABLED?: string;
  FROGX_BOT_TRADING_ENABLED?: string;
  FROGX_BOT_EXECUTION_ENABLED?: string;
  FROGX_BOT_API_TOKEN?: string;
  FROGX_BOT_MAX_TRADE_SOL?: string;
  FROGX_BOT_DAILY_SPEND_SOL?: string;
  FROGX_BOT_MAX_SLIPPAGE_BPS?: string;
  FROGX_BOT_INTENT_TTL_SECONDS?: string;
  FROGX_NFT_MAX_SWEEP_QUANTITY?: string;
  FROGX_NFT_SWEEP_ITEM_DELAY_MS?: string;
  FROGX_NFT_MAX_TOTAL_SOL?: string;
  FROGX_NFT_PREFLIGHT_ENABLED?: string;
  FROGX_NFT_PREFLIGHT_SCAN_LIMIT?: string;
  FROGX_NFT_LISTING_SCAN_LIMIT?: string;
  SOLANA_CAIP2?: string;
  PRIVY_APP_ID?: string;
