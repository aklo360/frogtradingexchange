...
Payout config: token `0x43298327b0249caF5A4942C6951F5Ac6AD7297A0`, escrow `0xC853Fc4dE86fC8868Fa89FC3B207d4592Db19e46`, 18 decimals. Keep `AIRDROP_PAYOUT_ENABLED=false` and `AIRDROP_AUTO_PAYOUT_ENABLED=false` until `AIRDROP_ESCROW_PRIVATE_KEY` is installed as a Worker secret; token bytecode exists, escrow has 10 `$DAEMON`, escrow has ETH gas, and `AIRDROP_ETH_RPC_URL` is already set.
