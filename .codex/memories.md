...
There is no public web Privy wallet-control surface. Privy wallet ownership and execution remain FTX/standalone-Ribbot concerns, and no Privy secret belongs in a browser bundle. Full live Worker/Ribbot credential compatibility and existing-wallet recovery still require private verification.
